...
export default function CatalogToolbar({ params, onChange, categories = [] }) {
    ...
    return (
        <div className="w-full rounded-xl border p-3 sm:p-4 bg-background/60 backdrop-blur">
            <div className="grid gap-3 sm:grid-cols-[minmax(0,2fr)_minmax(0,1fr)_minmax(0,1fr)_auto] sm:items-end">
                ...
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        <Search className="absolute left-2 top-1/2 -translate-y-1/2 size-4 opacity-60" aria-hidden />
                        <Input
                            id="catalog-search"
                ...
                {hasCategories ? (
                    <div className="space-y-1">
                        ...
                        <Select
                            ...
                            onValueChange={(v) => onChange?.((prev) => ({ ...prev, category: v === "all" ? null : v }))}
                        >
                            <SelectTrigger>
                ...
                <div className="space-y-1 sm:justify-self-end">
                    ...
                    <Button
                        ...
                        disabled={isPristine}   // see helper below
                        title="Reset filters"
                    >
